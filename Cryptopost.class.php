...
* 
* V. 1.01:  - If no RSA private key is present in session when cryptoPost_key is
...
{   
    ...
    * 'cryptoPost' : With the AES 256 encrypted serialized form data.
    * 'cryptoPost_key': Whith the RSA encrypted (with public key) AES 256 key.
    * 
    * Next times in that session 'cryptopost_key' is not needed.
    * 
    * The form id must be serialized inside the 'cryptoPost' content assigned to
    * the 'cryptoPost_form' key.
    * 
    ...
    */
    ...
    {   
        ...
        $formId = $_POST['cryptoPost_form'];
        
        unset($_POST['cryptoPost'], $_POST['cryptoPost_form']);
    ...
    */
    public function encodeData($data, $formId)
    {
        ...
        $union .= 'cryptoPost_form' . self::SEPARATOR1 . $formId;
